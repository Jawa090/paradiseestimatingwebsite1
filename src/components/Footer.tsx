...
const Footer = () => {
          ...
          <div>
            <div className="flex items-center mb-4">
              <div className="h-10 w-10 bg-gold rounded-full flex items-center justify-center mr-2 overflow-hidden">
                <img                  src="/lovable-uploads/1598254f-67ec-42a0-bc7e-f7435098e398.png"                  alt="Paradise Estimating Logo"                  className="h-14 w-14 mr-2 object-contain"               />
              </div>
  ...
  <ul className="space-y-2">
    <li className="flex items-start">
      ...
      <span className="text-gray-300">Paradise Estimating Services<br />898 Bay Ridge Avenue, Brooklyn, NY, United States</span>
    </li>
    <li className="flex items-start">
      <svg
        className="w-5 h-5 mt-1 mr-2 text-gold"
      ...
      <span className="text-gray-300">Corporate Office<br />4215 Lunar Way, Union City, CA, United States</span>
    </li>
    <li className="flex items-center">
      ...
      <span className="text-gray-300">718-719-6171 (Brooklyn)<br />510-335-7751 (California)</span>
    </li>
    <li className="flex items-center">
      <svg
        className="w-5 h-5 mr-2 text-gold"
      ...
      <span className="text-gray-300">sales@paradiseestimating.com</span>
    </li>
    <li className="flex items-center">
      <svg
        className="w-5 h-5 mr-2 text-gold"
